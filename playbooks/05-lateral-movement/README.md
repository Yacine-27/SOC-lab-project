...
```
<img width="1676" height="821" alt="lateral-movement-execution" src="https://github.com/user-attachments/assets/0f94eab7-a73a-4787-a77f-6519d07341cb" />

## Detection:
 Looking for successful logons with Logon_type=10 (RDP connections)

 <img width="1517" height="456" alt="lateral-movement-rdp-detection" src="https://github.com/user-attachments/assets/db5ddac7-b614-4ca7-9c99-5e16379a397d" />
