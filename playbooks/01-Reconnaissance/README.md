...
```
The attacker discovered the available machine, and which machine is the DC:

<img width="1398" height="548" alt="nmap execution" src="https://github.com/user-attachments/assets/03a997fd-2bbf-49c7-8e5f-e9a45f4e051f" />
...
<img width="1511" height="761" alt="suricata nmap" src="https://github.com/user-attachments/assets/8859ec1f-1003-4ed2-a87b-fa682cc9ad4c" />


Filtering for commands ran by the attacker machine:

<img width="1501" height="517" alt="attacker-command-wazuh" src="https://github.com/user-attachments/assets/92db835e-4d01-4855-a311-9820af6609fc" />
